        ...
        <el-col :span="12">
          <el-row type="flex" justify="space-between" class="flight-info-center">
            <el-col :span="8" class="flight-airport">
              ...
              <span>{{data.org_airport_name}}{{data.arg_airport_quay}}</span>
            </el-col>
        ...
        <el-col :span="20">
          ...
          >
            ...
            <el-col :span="3" class="choose-button">
              <el-button type="warning" size="mini" @click="jumpTerm(item.seat_xid)">选定</el-button>
...
export default {
  ...
  //  computed和data一样都可以在模板中渲染，区别在computed的属性是一个函数
  // 最终的变量的值是由函数返回
  computed: {
    //  计算相隔时间
    rankTime() {
